          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 bg-gray-50 flex flex-col gap-4">
              ...
              <div className="flex gap-2">
                <div className="w-8 h-8 rounded-full bg-[#d52b1e] flex items-center justify-center text-white flex-shrink-0">
              ...
              {/* User search query bubble if typed */}
              {debouncedQuery && (
                <div className="flex gap-2 justify-end">
                  <div className="bg-[#d52b1e] p-3 rounded-2xl rounded-tr-sm shadow-sm text-sm text-white">
              ...
              {!isSearching && debouncedQuery && results.length === 0 && (
                <div className="flex gap-2">
                  ...
                  <div className="bg-white p-3 rounded-2xl rounded-tl-sm border border-gray-100 shadow-sm text-sm text-gray-700">
                    I couldn't find any resources matching your search. Try different keywords.
                  </div>
                </div>
              )}
            </div>
